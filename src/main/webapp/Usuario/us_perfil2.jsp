<%-- 
    Document   : us_perfil2
    Created on : 3 may 2025, 3:17:57 a.m.
    Author     : blant
--%>
    ...
    <center>
        <div class=" container col-md-4 justify-content-center my-5">
            <div class="d-flex align-items-center mb-4 justify-content-center gap-3">
                <form action="../Admin/Paciente/pac_procesa.jsp" method="post">
                    ...
                    Estatus<br>
                    <input type="text" name="estatus" class="form-control" disabled readonly
