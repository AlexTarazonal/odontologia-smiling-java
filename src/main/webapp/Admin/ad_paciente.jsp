<%-- 
    ...
    Created on : 1 may 2025, 2:32:59 a.m.
    Author     : blant
--%>
                    ...
                    <div class="position-absolute top-1 end-0">
                        ...
                        <table class="table table-light table-striped table-hover">
                            ...
                            <%
                                ...
                                lista = paciente.muestraPacientes();
                            ...
                            %>
                                <tr>
                                    ...
                                    <td><%= p.getCorreo() %></td>
                                    <td><%= p.getEstatus() %></td>
                                    <td><a href="Paciente/pac_editar.jsp?id=<%=p.getId()%>"  class="btn btn-warning"> 
                                    <i class="fa-solid fa-pen-to-square" style="color:#000000;"aria-hidden="true"<!-- < -->
                                    </a></td>
                                    <td><a href="Paciente/pac_eliminar.jsp?id=<%=p.getId()%>" class="btn btn-danger">
