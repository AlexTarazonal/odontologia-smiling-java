<%-- 
    Document   : user_eliminar
    Created on : 1 may 2025, 5:10:01 a.m.
    Author     : blant
--%>
        ...
        <div class=" container col-md-4 justify-content-center my-5">
            <div class="d-flex align-items-center mb-4 justify-content-center gap-3">
                <form action="user_procesa.jsp">
                    ...
                    Password <br><!-- comment -->
                    <input type="text" name="psw"  class="form-control" readonly="true" 
                           value="<jsp:getProperty name="usuario" property="password"></jsp:getProperty>">
                    Nombre <br>
                    <input type="text" name="nom"  class="form-control" readonly="true" 
