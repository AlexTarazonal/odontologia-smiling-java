...
<head><!-- … mismo head … --></head>
<body class="d-flex">
 <%@ include file="/Doctor/include/sidebar_doctor.jsp" %>
  <div class="container p-4">
    <h2>Diagnóstico</h2>
    <!-- Aquí tu formulario o lista de diagnósticos -->
    <p>Seleccione un paciente para ver o crear diagnóstico.</p>
  </div>
</body>
</html>
