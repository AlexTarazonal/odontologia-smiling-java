                ...
                <table class="table table-light table-striped table-hover">
                    ...
                    %>
                        <tr>
                            ...
                            <td><a href="Doctor/doc_editar.jsp?id=<%=d.getId()%>"  class="btn btn-warning">
                            <i class="fa-solid fa-pen-to-square" style="color:#000000;"aria-hidden="true"<!-- < -->
                            </a></td>
                            <td><a href="Doctor/doc_eliminar.jsp?id=<%=d.getId()%>" class="btn btn-danger">
